...
export interface WebhookConfig {
    ...
    READ: string;
    UPDATE: string;
    UPDATE_DIRECT: string;
    MAGIC_LINK_SEND: string;
    MAGIC_LINK_VERIFY: string;
    CHECK_EXISTS: string;
    SECURE_CREATE: string;
    SECURE_UPDATE: string;
    SECURE_GET: string;
    AUDIT_LOG: string;
}
...
export interface RandomEndpoints {
    GENERATE: string;
    STORY: string;
}
...
function getN8NUrlDynamic(): string {
    const url = getN8NUrl();
...
function buildN8NUrl(path: string): string {
...
export const WEBHOOKS: WebhooksConfig = {
    // Account Management
    ACCOUNT: {
