...
export function testLimitConsistency(): void {
    console.log('🔍 Testing Limit Consistency...');

    const testCases = [
        { isLoggedIn: false, tier: 'free' as const, used: 0, expectedLimit: 3 },
        { isLoggedIn: false, tier: 'free' as const, used: 3, expectedLimit: 3 },
        { isLoggedIn: true, tier: 'free' as const, used: 0, expectedLimit: 9 },
        { isLoggedIn: true, tier: 'free' as const, used: 9, expectedLimit: 9 },
        { isLoggedIn: true, tier: 'pro' as const, used: 0, expectedLimit: 25 },
        { isLoggedIn: true, tier: 'pro' as const, used: 25, expectedLimit: 25 }
    ];
