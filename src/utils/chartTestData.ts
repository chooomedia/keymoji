 ...
 */
export function generateProMockData(days: number = 28): UsageHistoryEntry[] {
 ...
 */
export function generateFreeMockData(days: number = 28): UsageHistoryEntry[] {
    const history: UsageHistoryEntry[] = [];
    const today = new Date();
 ...
 */
export function generateDramaticPattern(days: number = 14, tier: 'pro' | 'free' = 'pro'): UsageHistoryEntry[] {
    const history: UsageHistoryEntry[] = [];
    const today = new Date();
 ...
 */
export function testProChart4Weeks(): void {
 ...
 */
export function testFreeChart7Days(): void {
 ...
 */
export function testDramaticPattern(): void {
 ...
 */
export function testProChart1Year(): void {
...
if (typeof window !== 'undefined' && process.env.NODE_ENV === 'development') {
    (window as { keymojiChartTest?: typeof keymojiChartTest }).keymojiChartTest = {
        // Quick tests
...
export default keymojiChartTest;
