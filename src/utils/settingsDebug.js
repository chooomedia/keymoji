...
export function debugSettings() {
    ...
    import('../stores/appStores.js').then(({ darkMode }) => {
    ...
    import('../stores/appStores.js').then(({ currentAccount, accountTier }) => {
...
export async function exportDebugData() {
    ...
    const { darkMode } = await import('../stores/appStores.js');
    const { userSettings, pendingChanges } = await import('../stores/userSettingsStore.js');
    const { currentAccount, accountTier } = await import('../stores/appStores.js');
