...
<div class="w-full fixed flex flex-wrap justify-center top-5 mx-auto">
    <nav class="md:w-4/12 w-full mx-3 bg-creme dark:bg-aubergine border-gray dark:bg-gray justify-center rounded-full">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto border-3">
            <a href="/" class="flex flex-col items-center space-x-3 rtl:space-x-reverse">
            ...
            <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                <button type="button" data-dropdown-toggle="language-dropdown-menu" class="bg-powder text-black dark:bg-aubergine-dark dark:text-powder py-3.5 px-4 rounded-full shadow-md transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none z-20 border-4 border-creme dark:border-aubergine">
                    <a href="/">
                ...
                <button data-collapse-toggle="navbar-language" type="button" class="bg-powder text-black dark:bg-aubergine-dark dark:text-powder py-3.5 px-4 rounded-full shadow-md transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none z-20 border-4 border-creme dark:border-aubergine" aria-controls="navbar-language" aria-expanded="false">
