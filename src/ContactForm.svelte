<script>
  ...
  let name = '',
      ...
      message = '',
      userInput = '',
      emoijSmirkingFace = './public/images/keymoji-animated-optimize-resize-160x160px.webp',
      realAuthorImage = './public/images/chris-matt-keymoji-creator-frontend-developer.png',
      whileLoading = "😏",
      isImageLoaded = false,
      isMessageSent = false,
      showRealImage = false,
