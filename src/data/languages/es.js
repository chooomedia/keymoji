...
export default {
    ...
    accountManager: {
        ...
        verified: 'Verificado',
        testBtn: 'Probar',
        apertusBuiltIn: 'Requiere un token de Hugging Face (hf_…) para usar Apertus.',
        apertusOwnToken: 'Introduce tu token de Hugging Face (hf_…). Obtén un token gratuito en huggingface.co.',
