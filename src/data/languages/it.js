...
export default {
    ...
    accountManager: {
        ...
        verified: 'Verificato',
        testBtn: 'Testa',
        apertusBuiltIn: 'Richiede un token Hugging Face (hf_…) per usare Apertus.',
        apertusOwnToken: 'Inserisci il tuo token Hugging Face (hf_…). Ottieni un token gratuito su huggingface.co.',
