...
export default {
    ...
    accountManager: {
        ...
        benefits: {
            free: {
                dailyGenerations: '10 daily secure generations',
                dailyGenerationsDesc:
                    'AI-resistant technology for maximum security',
                decentralizedData: 'Free Swiss AI',
                decentralizedDataDesc:
                    'Use Apertus, ChatGPT, Gemini, Claude, Mistral & more - directly usable',
        ...
        apiKeyLabelCustom: 'Custom API Key',
        optional: 'optional',
        verified: 'Verified',
        testBtn: 'Test',
        apertusBuiltIn: 'Requires a Hugging Face token (hf_…) to use Apertus.',
        apertusOwnToken: 'Enter your Hugging Face token (hf_…). Get a free token at huggingface.co.',
