...
export default {
    ...
    index: {
        ...
        setupStoryModeBannerText: "😊 QInlIj: tlhIngan bom'e' lIj",
    ...
    accountManager: {
        ...
        accountAge: {
            ...
            createdTodayPro: "💎 PRO club - DaHjaj!",
        ...
        messages: {
            ...
            creatingNewAccount: "Huch Qan chu' chenmoH - QI'yaH lIj yIlan.",
