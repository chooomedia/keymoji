...
export default {
    ...
    accountManager: {
        ...
        verified: 'Vérifié',
        testBtn: 'Tester',
        apertusBuiltIn: 'Nécessite un token Hugging Face (hf_…) pour utiliser Apertus.',
        apertusOwnToken: 'Entrez votre token Hugging Face (hf_…). Obtenez un token gratuit sur huggingface.co.',
