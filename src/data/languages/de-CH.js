...
export default {
    ...
    accountManager: {
        ...
        testBtn: 'Teste',
        apertusBuiltIn: 'Bruucht en Hugging-Face-Token (hf_…) zum Apertus z\'verwende.',
        apertusOwnToken: 'Hugging-Face-Token (hf_…) yygebe. Koschtlose Token uf huggingface.co hole.',
