                                                ...
                                                {#if apiKeysItem}
                                                    ...
                                                    <div class="space-y-3 bg-powder-100 dark:bg-aubergine-950 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                                                        ...
                                                        <div class="text-xs space-y-1.5 mt-1">
                                                            {#if isApertus}
                                                                <p class="text-amber-700 dark:text-amber-400 flex items-center gap-1">
                                                                    ...
                                                                    {$translations?.accountManager?.apertusBuiltIn || 'Requires a Hugging Face token (hf_…) to use Apertus.'}
                                                                </p>
                                                                <p class="text-gray-500 dark:text-gray-400">
                                                                    {$translations?.accountManager?.apertusOwnToken || 'Enter your Hugging Face token (hf_…). Get a free token at huggingface.co.'}
                                                                </p>
