...
<script>
    ...
    $: {
        if (pageType && content[$currentLanguage]?.[pageType]) {
            ...
            pageDescription =
                description ||
                content[$currentLanguage][pageType].pageDescription;
            pageKeywords =
                keywords || content[$currentLanguage][pageType].pageKeywords;
        } else {
            pageTitle =
                title ||
            ...
            pageDescription =
                ...
                'Generate secure emoji passwords';
            pageKeywords =
                keywords ||
                content[$currentLanguage]?.index?.pageKeywords ||
                'emoji, password, security';
        }
    }
...
<svelte:head>
    ...
    <meta property="og:image" content={image.startsWith('http') ? image :
    ...
    <meta name="twitter:image" content={image.startsWith('http') ? image :
    `https://keymoji.wtf${image}`} />
